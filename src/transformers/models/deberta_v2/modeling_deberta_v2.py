...
class DebertaV2ForMaskedLM(DebertaV2PreTrainedModel):
    ...
    def __init__(self, config):
        super().__init__(config)
        self.legacy = getattr(config, "legacy", False)
        ...
        if self.legacy:
            ...
            self._tied_weights_keys = ["lm_predictions.lm_head.decoder.weight", "deberta.embeddings.word_embeddings.weight"]
    ...
    def set_output_embeddings(self, new_embeddings):
        if self.legacy:
            ...
            self.lm_predictions.lm_head.decoder.bias = new_embeddings.bias
