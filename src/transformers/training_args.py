...
class TrainingArguments:
    ...
    Parameters:
        ...
        stable_train_warmup_steps (`int`, *optional*, defaults to 2):
    ...
    stable_train_warmup_steps: int = field(default=2, metadata={"help": "warmup steps to skip before collecting training performance."})
