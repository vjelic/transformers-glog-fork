...
class Emu3Vision2TextModelTest(ModelTesterMixin, GenerationTesterMixin, PipelineTesterMixin, unittest.TestCase):
    ...
    def test_assisted_decoding_matches_greedy_search_0_random(self):
        super().test_assisted_decoding_matches_greedy_search_0_random()

    @skipIfRocm
    def test_assisted_decoding_matches_greedy_search_1_same(self):
        super().test_assisted_decoding_matches_greedy_search_1_same()
    ...
    def test_assisted_decoding_with_logits_to_keep(self):
        super().test_assisted_decoding_with_logits_to_keep()
    ...
    def test_contrastive_generate_low_memory(self):
        super().test_contrastive_generate_low_memory()
